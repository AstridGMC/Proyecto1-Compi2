...
SIMBOLOS:  
	...
	| asterisco   			{$$=$1;}
	| dosPuntosConsecutivos {$$=$1;}//antes debe de haber un /id/ o //id/ etc, sino error semantico
	| punto 				{$$=$1;}//antes debe de haber un /id/  //id/ etc, sino error semantico
	| FUNCION
	| METODOS
	| TIPO_ID
;
...
OPERACION_ARITMETICA :
	T1 OPERACION_ARITMETICA_PRIMA ;

OPERACION_ARITMETICA_PRIMA:	
	mas T1 OPERACION_ARITMETICA_PRIMA
	| menos T1 OPERACION_ARITMETICA_PRIMA
	|										{$$=[];}
;
...
F : 
	TIPOIGUALAR
	| parizq OPERACION_ARITMETICA parder {$$=$2;}
;

TIPOIGUALAR:
	entero						{$$=$1;}
	| decimal 					{$$=$1;}
	| arroba SIGUIENTE_ARROBA	{$$=$1;}
	| cadena					{$$=$1;}
	| CONSULTAS					{$$=$1;}
	| METODOS					{$$=$1;}
;